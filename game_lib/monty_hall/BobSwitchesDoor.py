...
#from monty_hall.AliceArrangeBalls import the same classes: Door() & DoorBar()
...
class BobSwitchesDoor():
    ...
    def __init__(self, AliceChoice):
        ...
        #default value of Bob's choice is 50:50
        self.DoorBars = [DoorBar(self.DoorPos[0], 0.5),
                         DoorBar(self.DoorPos[1], 0.5),]
