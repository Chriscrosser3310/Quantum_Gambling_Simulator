...
class GBButton():
    ...
    def __init__(self, pos, angle, color, text=''):
        ...
        if self.text == 'GOOD!':
            self.font = pygame.font.SysFont('timesnewroman', int(30*self.ratio[0]))
    ...
    def draw(self, surface):
        ...
        surface.blit(self.text0, (self.rect.center[0]-self.text0.get_width()/2, self.rect.center[0]-self.text0.get_height()/2))
